# MockupBuddy - PyQt Edition v0.4.5
# ✅ Focused patch: Multiply Blend Mode fix with accurate overlay placement
# ✅ Folder persistence (inherited from v0.4.4)
# ✅ Maintains preview + output integrity without wiping background
...
class MockupBuddy(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("MockupBuddy v0.4.5")
    ...
    def setup_ui(self):
        ...
        self.chk_multiply.setChecked(False)
    ...
    def overlay_design(self, mockup, design):
        try:
            ...
            if self.use_multiply:
                ...
                return Image.alpha_composite(mockup, overlay)
        except Exception as e:
