# MockupBuddy - PyQt Edition v0.4.6
# ✅ Fully restored MVP features: Opacity, X/Y offset, Size, Aspect Ratio
# ❌ Removed Multiply Blend Mode (de-scoped)
# ✅ Folder persistence retained
...
class MockupBuddy(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("MockupBuddy v0.4.6")
