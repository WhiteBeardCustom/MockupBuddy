# MockupBuddy_PySide6_v0.6.5_FULL
# ✅ Based on the last known good version: v0.6.4a
# ✅ Includes:
#    - All features from v0.6.3a + v0.6.4a
#    - Slider containment + UI layout polish
# This is a placeholder. Final integrated source code to follow in live message blocks if export continues to fail.
import sys
import os
import json
...
class MockupBuddy(QMainWindow):
    def __init__(self):
        ...
        self.checkbox_vars = []  # list of (mockup_file, QCheckBox, DarkBG CheckBox)
        self.init_ui()
